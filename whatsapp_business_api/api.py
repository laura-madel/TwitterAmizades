...
class WhatsappAPI:
    ...
    def __init__(self, phone_number_id: Union[int, str], access_token: str) -> None:
        self.__phone_number_id: str = str(phone_number_id).replace(' ','').replace('+', '')
    ...
    def send_text_message(self, to: str, message: str) -> None:
        payload = ApiRequestPayload(to=to, type='text', text=OutgoingTextPayload(preview_url=True, body=message))
